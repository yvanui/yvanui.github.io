...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,1);function T(v,f,B,P,M,x){const a=t("YvCallOut"),e=t("YvBeanSchema");return h(),o("div",null,[d,n(a,{type:"connector",title:"URL: /mfc/alkTaskPriorityModify"},{default:i(()=>[c,u,E,y]),_:1}),_,n(a,{type:"info",title:"数据结构"},{default:i(()=>[m]),_:1}),n(e,{content:`{
  "root": {
  "valueType" : "object",
  "properties" : {
    "reqCode" : {
