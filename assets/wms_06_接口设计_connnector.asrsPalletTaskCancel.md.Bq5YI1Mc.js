import{_ as r,c as h,J as n,w as i,m as s,a as l,a6 as p,G as t,o}from"./chunks/framework.d-Ywx6yJ.js";const N=JSON.parse('{"title":"asrsPalletTaskCancel","description":"","frontmatter":{"title":"asrsPalletTaskCancel","desc":"3.1.3-托盘搬运任务取消","type":"connector","apiType":"External","system":"WCS","date":"2024-03-29 10:56","author":"yvan","navIgnore":true,"url":"/wcs/asrsPalletTaskCancel","tags":["wms/connector","wms/connector3-WCS接口/3_1-托盘立库","wms/connector/wcs/asrsPalletTaskCancel"]},"headers":[],"relativePath":"wms/06_接口设计/connnector.asrsPalletTaskCancel.md","filePath":"wms/06_接口设计/connnector.asrsPalletTaskCancel.md"}'),k={name:"wms/06_接口设计/connnector.asrsPalletTaskCancel.md"},c=s("h3",{id:"_3-1-3-托盘搬运任务取消",tabindex:"-1"},[l("3.1.3-托盘搬运任务取消 "),s("a",{class:"header-anchor",href:"#_3-1-3-托盘搬运任务取消","aria-label":'Permalink to "3.1.3-托盘搬运任务取消"'},"​")],-1),d=s("p",null,"描述: 3.1.3-托盘搬运任务取消",-1),u=s("p",null,"名称: asrsPalletTaskCancel",-1),E=s("p",null,"内部方法：com.galaxis.wms.connector.WCS@asrsPalletTaskCancel",-1),y=s("p",null,"内部编号: 8350f2f4-433f-4808-8195-7c34202dad48",-1),_=s("h4",{id:"请求",tabindex:"-1"},[l("请求 "),s("a",{class:"header-anchor",href:"#请求","aria-label":'Permalink to "请求"'},"​")],-1),g=s("p",null,null,-1),m=s("p",null,null,-1),C=p(`<div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,1);function T(v,B,f,P,S,w){const a=t("YvCallOut"),e=t("YvBeanSchema");return o(),h("div",null,[c,n(a,{type:"connector",title:"URL: /wcs/asrsPalletTaskCancel"},{default:i(()=>[d,u,E,y]),_:1}),_,n(a,{type:"info",title:"数据结构"},{default:i(()=>[g]),_:1}),n(e,{content:`{
  "root": {
  "valueType" : "object",
  "properties" : {
    "reqCode" : {
