import{_ as r,c as h,J as n,w as i,m as s,a as l,a6 as p,G as t,o}from"./chunks/framework.d-Ywx6yJ.js";const P=JSON.parse('{"title":"ccAgvStackingAdd","description":"","frontmatter":{"title":"ccAgvStackingAdd","desc":"3.6.2-托盘叠盘任务添加","type":"connector","apiType":"External","system":"RCS","date":"2024-03-29 10:56","author":"yvan","navIgnore":true,"url":"/rcs/ccAgvStackingAdd","tags":["wms/connector","wms/connector3-WCS接口/3_6-侧叉式AGV","wms/connector/rcs/ccAgvStackingAdd"]},"headers":[],"relativePath":"wms/06_接口设计/connnector.ccAgvStackingAdd.md","filePath":"wms/06_接口设计/connnector.ccAgvStackingAdd.md"}'),c={name:"wms/06_接口设计/connnector.ccAgvStackingAdd.md"},k=s("h3",{id:"_3-6-2-托盘叠盘任务添加",tabindex:"-1"},[l("3.6.2-托盘叠盘任务添加 "),s("a",{class:"header-anchor",href:"#_3-6-2-托盘叠盘任务添加","aria-label":'Permalink to "3.6.2-托盘叠盘任务添加"'},"​")],-1),d=s("p",null,"描述: 3.6.2-托盘叠盘任务添加",-1),u=s("p",null,"名称: ccAgvStackingAdd",-1),E=s("p",null,"内部方法：com.galaxis.wms.connector.RCS@ccAgvStackingAdd",-1),g=s("p",null,"内部编号: 36878c47-dec2-4774-a463-002347a3fd15",-1),y=s("h4",{id:"请求",tabindex:"-1"},[l("请求 "),s("a",{class:"header-anchor",href:"#请求","aria-label":'Permalink to "请求"'},"​")],-1),_=s("p",null,null,-1),m=s("p",null,null,-1),b=p(`<div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,1);function v(T,A,B,S,f,x){const a=t("YvCallOut"),e=t("YvBeanSchema");return o(),h("div",null,[k,n(a,{type:"connector",title:"URL: /rcs/ccAgvStackingAdd"},{default:i(()=>[d,u,E,g]),_:1}),y,n(a,{type:"info",title:"数据结构"},{default:i(()=>[_]),_:1}),n(e,{content:`{
  "root": {
  "valueType" : "object",
  "properties" : {
    "reqCode" : {
