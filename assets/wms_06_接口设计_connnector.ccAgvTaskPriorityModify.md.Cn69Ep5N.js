import{_ as r,c as o,J as n,w as a,m as s,a as l,a6 as p,G as t,o as h}from"./chunks/framework.d-Ywx6yJ.js";const M=JSON.parse('{"title":"ccAgvTaskPriorityModify","description":"","frontmatter":{"title":"ccAgvTaskPriorityModify","desc":"3.6.3-托盘任务优先级调整","type":"connector","apiType":"External","system":"RCS","date":"2024-03-29 10:56","author":"yvan","navIgnore":true,"url":"/rcs/ccAgvTaskPriorityModify","tags":["wms/connector","wms/connector3-WCS接口/3_6-侧叉式AGV","wms/connector/rcs/ccAgvTaskPriorityModify"]},"headers":[],"relativePath":"wms/06_接口设计/connnector.ccAgvTaskPriorityModify.md","filePath":"wms/06_接口设计/connnector.ccAgvTaskPriorityModify.md"}'),c={name:"wms/06_接口设计/connnector.ccAgvTaskPriorityModify.md"},k=s("h3",{id:"_3-6-3-托盘任务优先级调整",tabindex:"-1"},[l("3.6.3-托盘任务优先级调整 "),s("a",{class:"header-anchor",href:"#_3-6-3-托盘任务优先级调整","aria-label":'Permalink to "3.6.3-托盘任务优先级调整"'},"​")],-1),d=s("p",null,"描述: 3.6.3-托盘任务优先级调整",-1),u=s("p",null,"名称: ccAgvTaskPriorityModify",-1),E=s("p",null,"内部方法：com.galaxis.wms.connector.RCS@ccAgvTaskPriorityModify",-1),y=s("p",null,"内部编号: 8983844f-2ce2-44d0-926e-d93b65555661",-1),g=s("h4",{id:"请求",tabindex:"-1"},[l("请求 "),s("a",{class:"header-anchor",href:"#请求","aria-label":'Permalink to "请求"'},"​")],-1),_=s("p",null,null,-1),m=s("p",null,null,-1),b=p(`<div class="language-json vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  &quot;reqCode&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;kjdig-002&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  &quot;reqCode&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;kjdig-002&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,1);function F(T,f,B,P,A,S){const i=t("YvCallOut"),e=t("YvBeanSchema");return h(),o("div",null,[k,n(i,{type:"connector",title:"URL: /rcs/ccAgvTaskPriorityModify"},{default:a(()=>[d,u,E,y]),_:1}),g,n(i,{type:"info",title:"数据结构"},{default:a(()=>[_]),_:1}),n(e,{content:`{
  "root": {
  "valueType" : "object",
  "properties" : {
    "reqCode" : {
...
`}),n(i,{type:"example",title:"响应示例 1"},{default:a(()=>[v]),_:1}),q])}const w=r(c,[["render",F]]);export{M as __pageData,w as default};
